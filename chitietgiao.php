...
$sql= "SELECT * FROM chitietgiao WHERE sophieugiao = ( SELECT MAX(sophieugiao) FROM chitietgiao )";
...
?>
<h2 text align="center" >Chi tiết giao</h2>
<table border="1" align="center" cellspacing="0" cellspallding="5" width="750px">
      ...
      <tr>
       ...
       <td><?php echo $row['soluonggiao']; ?></td>
       <td><?php echo $row['tinhtrangtb']; ?></td>
       <td> <a href="inphieugiao.php" ><i class="fas fa-print"></i></td>
       </div>
            </div>
          </div>
        </div>
