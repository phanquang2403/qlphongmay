...
$sql= "SELECT * FROM chitietnhan WHERE sophieunhan = ( SELECT MAX(sophieunhan) FROM chitietnhan )";
...
?>
<h2 text align="center" >Chi tiết nhận</h2>
<table border="1" align="center" cellspacing="0" cellspallding="5" width="750px">
      ...
      <tr>
       <td><?php echo $row['sophieunhan']; ?></td>
       <td><?php echo $row['tenvt']; ?></td>
       <td><?php echo $row['Soluongnhan']; ?></td>
       <td><?php echo $row['trinhtangvattu']; ?></td>
       <td> <a href="inphieunhan.php" ><i class="fas fa-print"></i></td>
       </div>
            </div>
          </div>
        </div>
