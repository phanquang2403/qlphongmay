...
?>
<h2 text align="center" >Danh sách phòng </h2>
<div>
 <table border="1" text align="center"> 
                <tr>
                    ...
                    <th>loại phòng</th>
                    <th>trạng thái</th>
                    <th> <a href="trangthemphong.php?id=123">Thêm phòng</a></th>
                            ...
                            <?php 
                             ...
                             <tr>
                                ...
                                <td><a href="trangsuaphong.php?id=<?php echo $row['id']; ?>">sửa</a> | <a href="xoa.php?id=<?php echo $row['id']; ?>">xóa | <a href="trangnhapvattu.php?id='<?php echo $row['id']; ?>'"> Nhập vật tư</a></td>
